...
namespace CarGame2D
{
    ...
    public class Game : Sprite, Updateable
    {
            ...
            : base("Background", ScreenSpace.Current.Viewport)
        {
            ...
            car = new Car(track.TrackStart, track, false);
            AiCars.Add(new Car(track.Positions[1], track, true));
            AiCars.Add(new Car(track.Positions[2], track, true));
        ...
        private readonly BackgroundWorker ai = new BackgroundWorker();
        private readonly Car car;
        private readonly List<Car> AiCars = new List<Car>();
